...
class EstateController extends Controller
{
    ...
    public function create()
    {
        try {
            ...
            $kinds = Kind::all();
            return view('frontend.estates.create', compact('cities', 'users', 'categories', 'kinds','zones', 'countries'));
        } catch (\Exception $e) {
            return redirect()->back()->with('error', 'حدث خطأ !!');
        }
    }
...
//            }
    ...
    public function edit($subdomain,$id)
    {
        ...
        if (isset($estate)) {
            ...
            $categories = Category::all();
            $kinds = Kind::all();
            return view('frontend.estates.edit', compact('estate', 'cities', 'zones','users', 'categories', 'kinds', 'countries'));
        } else {
            return redirect()->back()->with('error', 'حدث خطأ !!');
        }
    }
