...
<head>
    ...
    <link rel="apple-touch-icon" href="{{ asset('frontend') }}/app-assets/images/ico/apple-icon-120.png">
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('frontend') }}/app-assets/images/ico/favicon.ico">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend') }}/app-assets/css-rtl/pages/authentication.css">
    <!-- END: Page CSS-->
...
<body class="vertical-layout vertical-menu-modern dark-layout  navbar-floating footer-static bg-full-screen-image  blank-page blank-page" data-open="click" data-menu="vertical-menu-modern" data-col="1-column" data-layout="dark-layout">
<!-- BEGIN: Content-->
                    ...
                    <div class="card bg-authentication rounded-0 mb-0">
                        <div class="row m-0">
                            <div class="col-lg-6 d-lg-block d-none text-center align-self-center px-1 py-0">
                                <img src="{{ asset('frontend') }}/app-assets/images/pages/login.png" alt="branding logo">
                            </div>
                            <div class="col-lg-6 col-12 p-0">
                                <div class="card rounded-0 mb-0 px-2">
                                    ...
                                    <p class="px-2">مرحبا بعودتك , قم بتسجيل الدخول للولوج الى لوحة تحكمك</p>
                                    <div class="card-content">
                                        <div class="card-body pt-1">
                                            <form method="POST" action="{{ route('login') }}">
                                                @csrf
                                                <fieldset class="form-label-group form-group position-relative has-icon-left">
                                                    <input name="email" type="email" class="form-control" id="user-name" placeholder="البريد" required>
                                                    <div class="form-control-position">
                                                        <i class="feather icon-user"></i>
                                                    </div>
                                                    <label for="user-name">البريد</label>
                                                </fieldset>
                                                <fieldset class="form-label-group position-relative has-icon-left">
                                                    <input name="password" type="password" class="form-control" id="user-password" placeholder="الرقم السري" required>
                                                    <div class="form-control-position">
                                                        <i class="feather icon-lock"></i>
                                                    </div>
                                                    <label for="user-password">الرقم السري</label>
                                                </fieldset>
                                                <button style="width: 100%;margin-bottom: 2em" type="submit" class="btn btn-primary float-right btn-inline">تسجيل الدخول</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
