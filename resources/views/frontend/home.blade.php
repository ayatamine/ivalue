...
@section('frontend-head')
    ...
    <link rel="stylesheet" type="text/css"
          href="{{ asset('frontend') }}/app-assets/vendors/css/extensions/tether.min.css">
    <link rel="stylesheet" type="text/css"
    ...
    <link rel="stylesheet" type="text/css"
          href="{{ asset('frontend') }}/app-assets/css-rtl/pages/dashboard-analytics.css">
    ...
    <section id="dashboard-analytics">
                ...
                <div class="card bg-analytics text-white">
                    <div class="card-content">
                        <div class="card-body text-center">
                            <img src="{{ asset('frontend') }}/app-assets/images/elements/decore-left.png"
                                 class="img-left" alt="
            card-img-left">
                            <img src="{{ asset('frontend') }}/app-assets/images/elements/decore-right.png"
                                 class="img-right" alt="
            card-img-right">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="mb-0">اخر من قام بعمليا تسجيل الدخول</h4>
                    </div>
                    <div class="card-content">
                        <div class="table-responsive mt-1">
                            <table class="table table-hover-animation mb-0">
