            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form method="post" action="{{ route('roles.update' ,['role'=>$role->id,'subdomain'=>Route::current()->parameter('subdomain')]) }}" id="myform" >
                                @csrf
                                {{ method_field('PATCH') }}
                                <div class="form-row">
                                ...
                                <div class="text-center mt-1 d-flex justify-center " style="gap: 1%">
                                    ...
                                    <a href="{{route('roles.index',Route::current()->parameter('subdomain'))}}" class="btn btn-danger w-50" type="submit">رجوع</a>
                                </div>
                            </form>
                        </div>
                    </div>
