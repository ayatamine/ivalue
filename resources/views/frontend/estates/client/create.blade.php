...
@section('frontend-head')
    <script type="text/javascript"
            src="https://maps.googleapis.com/maps/api/js?key={{env('MAP_KEY')}}&libraries=places&sensor=true"></script>
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form method="post" action="{{ route('client.estates.store',Route::current()->parameter('subdomain')) }}" id="myform"
                                ...
                                <div class="form-row">
                                    ...
                                    {{-- <div class="col-md-3 col-12 mb-3">
                                        ...
                                        <input type="text" name="name_english" class="form-control" id="name_english"
                                               placeholder="الاسم " value="{{old('name_english')}}" required>
                                        @error('name_english')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div> --}}
