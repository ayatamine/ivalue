        ...
        @include('frontend.steps.estate_includes.estate_info')
            ...
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        <form method="post" action="{{ route('estate_paid_post' , ['estate_id'=>$estate->id,'subdomain'=>Route::current()->parameter('subdomain')]) }}" id="myform"
                                ...
                                <div class="col-sm-12 col-12">
                                    ...
                                    <div class="form-group">
                                        <select name="accept" id="accept"
                                            ...
                                            <option selected value="1">موافقة وارسال الى العميل </option>
