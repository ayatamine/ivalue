                ...
                <div class="btn-dropdown mr-1 mb-1">
                    <div class="btn-group dropdown actions-dropodown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" href="{{ route('cities.create') }}"><i class="fa fa-plus"></i>اضافة جديد</a>
                            <a class="dropdown-item delete-all" onclick="return false;" delete_url="/delete_cities/">
                                حذف الكل</a>
                        </div>
                    </div>
                </div>
                    ...
                    @foreach($cities as $country)
                        <tr class="delete-all-cats">
                            ...
                            <td class="product-action">
                                <span class="action-edit"><a href="{{ route('cities.edit' , $country->id) }}"><i class="feather icon-edit"></i></a></span>
                                <a title="" onclick="return false;" object_id="{{ $country->id }}"
                                   delete_url="/estate/public/cities/" class="edit-btn-table remove-alert" href="#">
