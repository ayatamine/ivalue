...
<!-- /Left Sidebar Menu -->
    ...
    <footer class="footer footer-static footer-light">
        ...
        <p class="clearfix blue-grey lighten-2 mb-0"><span class="float-md-left d-none d-md-block">جميع الحقوق محفوظة لشركة حلول نت الرقمية</span>
            <button class="btn btn-primary btn-icon scroll-top" type="button"><i class="feather icon-arrow-up"></i>
            </button>
        </p>
        <p class="clearfix blue-grey lighten-2 mb-0"><span class="float-md-right d-none d-md-block">مصمم ومبرمج بكل حب<i
