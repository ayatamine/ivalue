            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title"> استخارج تقرير </h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            <form method="post" action="{{ route('report_form') }}">
                                        ...
                                        <div class="col-sm-12 col-12">
                                            ...
                                            <div class="form-group">
                                                <select name="id" id="id"
                                                    ...
                                                    <option selected hidden disabled value="">اختر العقار</option>
                                                    @foreach($estates as $kind)
                                                        <option value="{{ $kind->id }}">{{ $kind->name_arabic }} </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            @error('kind_id')
                                ...
                                <hr>
                                <button class="btn btn-primary" type="submit">استخراج</button>
                            </form>
                        </div>
                    </div>
                </div>
