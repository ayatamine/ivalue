...
@section('frontend-main')
    ...
    <div class="content-body">
        ...
        <section id="data-thumb-view" class="data-thumb-view-header">
            <h3>
                تكلفة الاحلال (الدليل الاسعار الاسترشادية) المخططات العامة لـــ
                {{ $estate->name_arabic }}
                <br>
            </h3>
            <div class="col-12">
                <a style="width: 100%" onclick="return confirm('هل انت متأكد من ذلك ؟!');" href="{{ route('land_delete' , ['id'=>$estate->id,'subdomain'=>Route::current()->parameter('subdomain')]) }}" class="btn btn-danger text-white">
