...
@section('frontend-main')
    ...
    <div class="content-body">
        ...
        <form method="post" action="{{ route('parking.store', Route::current()->parameter('subdomain')) }}" id="myform">
            @csrf
            <div class="form-row">
                <div class="col-sm-12 col-12">
                    <h3 class="text-center">
                        تكلفة الاحلال (الدليل الاسعار الاسترشادية) مواقف السيارات
                    </h3>
                    <hr/>
                </div>
                 <?php
                        ...
                        <div class="table-responsive">
                            <table style="width:100%" class="table data-thumb-view">
                                <tr>
                                    <th>مساحة الأرض</th>
                                    <td>
                                        <input id="land" type="number" step="0.01" name="value[6]" class="form-control"
                                               placeholder="القيمة "
                                               value="{{ old('value[6]') }}" required readonly>
                                        م2
                                    </td>
                                </tr>
                                <tr>
...
@section('frontend-footer')
    ...
    <script>
        ...
        $('input[name="value[4]"]').on('keydown, keyup', function () {
            ...
            $('input[name="value[8]"]').val(input_7 * input_4);
        });
        ...
        $('input[name="value[5]"]').on('keydown, keyup', function () {
            ...
            $('input[name="value[10]"]').val(input_9 * input_5);
        });
        ...
        $('input[name="value[3]"]').on('keydown, keyup', function () {
            ...
            $('input[name="value[12]"]').val(input_11 * input_3);
        });
        ...
        $('input[name="value[4]"]').on('keydown, keyup', function () {
            ...
            $('input[name="value[13]"]').val(input_8 + input_10 + input_12);
        });
        $('input[name="value[7]"]').on('keydown, keyup', function () {
            var input_8 = parseInt($('input[name="value[8]"]').val());
            var input_10 = parseInt($('input[name="value[10]"]').val());
        ...
        $('input[name="value[14]"]').on('keydown, keyup', function () {
            ...
            var input_15 = parseInt($('input[name="value[15]"]').val()) / 100 ;
            var input_16 = parseInt($('input[name="value[16]"]').val()) / 100 ;
            var input_17 = parseInt($('input[name="value[17]"]').val()) / 100 ;
            $('input[name="value[18]"]').val(input_13 * input_14 * input_15 * input_16 * input_17);
        });
        ...
        $('input[name="value[14]"]').on('keydown, keyup', function () {
            ...
            $('input[name="value[19]"]').val(input_13 + input_18);
            $('input[name="value[23]"]').val(input_13 + input_18);
        });
        $('input[name="value[15]"]').on('keydown, keyup', function () {
            var input_13 = parseInt($('input[name="value[13]"]').val());
            var input_18 = parseInt($('input[name="value[18]"]').val());
        ...
        $('input[name="value[18]"]').on('keydown, keyup , change', function () {
            var input_13 = parseInt($('input[name="value[13]"]').val());
            var input_18 = parseInt($('input[name="value[18]"]').val());
            $('input[name="value[19]"]').val(input_13 + input_18);
            $('input[name="value[23]"]').val(input_13 + input_18);
        ...
        $('input[name="value[20]"]').on('keydown, keyup', function () {
            ...
            $('input[name="value[22]"]').val((input_20 - input_21) / input_20 * 100);
        });
        ...
        $('input[name="value[20]"]').on('keydown, keyup', function () {
            ...
            $('input[name="value[24]"]').val(input_23 * input_22);
        });
        $('input[name="value[21]"]').on('keydown, keyup , change', function () {
            var input_23 = parseInt($('input[name="value[23]"]').val());
            var input_22 = parseInt($('input[name="value[22]"]').val()) / 100;
        ...
        $('input[name="value[20]"]').on('keydown, keyup', function () {
            ...
            $('input[name="value[25]"]').val(input_23 - input_24);
            $('input[name="value[27]"]').val(input_23 - input_24);
        });
        $('input[name="value[21]"]').on('keydown, keyup , change', function () {
            var input_23 = parseInt($('input[name="value[23]"]').val());
            var input_24 = parseInt($('input[name="value[24]"]').val());
