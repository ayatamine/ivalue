...
@section('backend-main')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">صفحات النظام</h4>
                    <div style="display: flex;justify-content: space-between;">
                        <a href="{{ route('pages.create') }}" class="btn btn-success mb-2"><i class="mdi mdi-plus mr-2"></i>اضافة جديد</a>
                        <a class="btn btn-danger mb-2  delete-all text-white" onclick="return false;"
                           delete_url="/delete_pages/"><i class="mdi mdi-trash-can-outline mr-2"></i>حذف الكل</a>
                    </div>
                    <hr>
