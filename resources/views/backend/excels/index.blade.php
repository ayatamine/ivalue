...
@section('backend-main')
    <div class="card-body">
        <form action="{{ route('import') }}" method="POST" enctype="multipart/form-data">
            ...
            <br>
            <button class="btn btn-success">ادخل ملف الايرادات</button>
        </form>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">الايرادات</h4>
                    <hr>
                    <table  class="table table-striped table-bordered dt-responsive nowrap"
                        ...
                        @foreach($imports as $key => $import)
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    + $import['7']+ $import['8']+ $import['9']+ $import['10']+ $import['11']+ $import['12']
                                    }}
                                </td>
                            </tr>
                            @endif
                        ...
                        <td>
                            <?php
                            $sum = 0;
                            foreach(\App\Models\Import::all() as $key=>$value)
                            {
                                if($key <= 11){
                                    $sum+= $value['1'];
                                }
