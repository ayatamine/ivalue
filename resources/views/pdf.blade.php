...
<div style="text-align: right;direction: rtl" class="page">
    ...
    <p>
        تم اعداد تقرير التقييم بناء على التعليمات التي تم تلقيها من العميل لتقدير القيمة السوقية للأصل محل التقييم، وقد
        اعد بواسطة المقيم / مؤسسة افكار العالمية للخدمات العقارية المعتمد من الهيئة السعودية للمقيمين المعتمدين، وقد قام
        بالمعاينة بعد فحص العقار محل التقييم وجمع البيانات والمعلومات وتحليلها لتكوين وتطوير رأي محايد عن القيمة السوقية
        للعقار المذكور ليتناسب مع الغرض الذي تم تحديده مسبقا وتماشيا مع معايير التقييم الدولية (IVSC) الصادرة في 2022م.
        ويقر المقيم بالاستقلالية وبعدم وجود اي تضارب في المصالح فيما يتعلق بالعميل، والمستخدمين المقصودين، وموضوع
        الملكية ومالكيها الحاليين، مما يمنعنا من تقديم رأي مستقل وموضوعي في قيمة الاصل محل التقييم.
    </p>
    <table class="table table-bordered">
        ...
        <tr>
            ...
            ?>
            <td>{{ $var ? $var->value : 'غير محدد' }}</td>
            <th scope="row">قيود العقار:</th>
            <td>{{ $var2 ? $var2->value : 'لا يوجد' }}</td>
        </tr>
        ...
        <tr>
            ...
            <td>
                {{ $var8 ? $var8->value : 'بدون' }}
            </td>
            <th scope="row">
                اسم المخطط:
            </th>
            <td>
                {{ $var9 ? $var9->value : 'بدون' }}
            </td>
        </tr>
